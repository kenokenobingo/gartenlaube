...
export const DAO_FACTORY_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x4A733de4213B5d966efD24582723d4a2CEDF9Cb1',
};
...
export const BANK_FACTORY_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x6EA3d0E4b0fD10943f5a6B58B830FC49E9D8F9df',
};
...
export const NFT_EXTENSION_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xD6E06dc0eAb962e5b339Ad73a3De1e80ed4dF76A',
};
...
export const NFT_COLLECTION_FACTORY_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x912d13E0F5428f6F36FC10867777d1109BCda277',
};
...
export const ERC20_TOKEN_FACTORY_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x344Ef993b3c29E001F904845A4ca328f0f08c514',
};
...
export const VOTING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xDF61d28E6A587C5AF76f92f20874245f06D1EbE4',
};
...
export const CONFIGURATION_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xb5fdFee63968c1E70e4a08fcE1140b05BE0180aa',
};
...
export const RAGEQUIT_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x4a80F321aE8D37fd624B62D828cF6f3c008Bc29b',
};
...
export const MANAGING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xe9D4241D35efdFee617af2350d76719FA4D566Df',
};
...
export const FINANCING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x8442c45bD00EAb8B479371516dc3fc3a1C456470',
};
...
export const ONBOARDING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x3Ec7B4471BBBa7CF50a3A144eAa9ef703e94C528',
};
...
export const GUILDKICK_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x1Fe433B6361d77d25b43D78cf19F1C4B69448700',
};
...
export const DAO_REGISTRY_ADAPTER_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xB40dd8f3cD26e23b1C4fF6810E78829f4381ca9e',
};
...
export const BANK_ADAPTER_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x6FE12c9a7da88eA9ba1b8b5903816ef9c4fa802e',
};
...
export const NFT_ADAPTER_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xFD3dB3E17EE0879ebd8CED5f63e34A93164bdfC2',
};
...
export const COUPONONBOARDING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xC22A3aE6932b7f71367bfB43Ec786571AE876434',
};
...
export const TRIBUTE_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x4d077aa745Ac64A6D4216C9cbc2c412f26a74643',
};
...
export const DISTRIBUTE_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xAe42A14A929bbe4B8Ce59ef6aB14bc21F45E0F62',
};
...
export const TRIBUTE_NFT_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x33931Cdbb82CeF0AB964b5146dF9f7Ab9C67e98b',
};
...
export const OFFCHAINVOTING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xfC4B4D8a4199D3648D9c5D2BaCb5C1938d322954',
};
